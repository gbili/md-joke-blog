...
describe(`TemplateEngine`, function() {
  ...
  describe(`getReferencedValue(data, ref)`, function() {
    ...
    it('should throw when trying to access non existing first level data', function() {
      ...
      expect(() => te.getReferencedValue(mockData, badRef)).to.throw('Trying to access a non existing param: ' + badRef);
    });
    it('should throw when trying to access non existing second level data', function() {
  ...
  describe(`replaceArray(template, data)`, function() {
    it('should throw if missing data ref using ref without element prefix', function() {
      expect(() => te.replaceArray(mockTemplate, mockData)).to.throw('Trying to access a non existing param: ' + ref6WithoutPrefix);
    });
